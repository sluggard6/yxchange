...
/**
 * A Currency class roughly modeled after {@link java.util.Currency}. Each
 * object retains the code it was acquired with -- so
 * {@link #getInstance}("BTC").{@link #getCurrencyCode}() will always be "BTC",
...
public class Currency implements Comparable<Currency>, Serializable {
	...
	/**
	 * Returns the Currency instance for the given currency code only if one already
	 * exists.
	 */
	 ...
	 *
	 * @param commonCode
	 *            commonly used code for this currency: "BTC"
	 * @param name
	 *            Name of the currency: "Bitcoin"
	 * @param unicode
	 *            Unicode symbol for the currency: "\u20BF" or "฿"
	 ...
	 *
	 * <p>
	 * This is useful in case some currencies share codes, such that
	 * {@link #getInstance(String)} may return the wrong currency.
	 *
	 * @param code
	 *            The code the returned object will evaluate to
	 * @return A Currency representing the same currency but having the passed
	 *         currency code
	...
	/**
	 * Gets the equivalent object with an ISO 4217 code, or if none a code which
	 * looks ISO compatible (starts with an X), or the constructed currency code if
	 * neither exist.
	 */
