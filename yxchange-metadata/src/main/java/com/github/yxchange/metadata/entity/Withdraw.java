...
public class Withdraw {
    ...
    public Withdraw(Integer id, Integer accountId, Integer addressId, BigDecimal amount, String transHash, Integer high, Integer state, Date createtime, Date modifytime) {
        this.id = id;
